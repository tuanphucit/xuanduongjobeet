...
abstract class autoCategoryActions extends sfActions
{
  ...
  protected function buildQuery()
  {
    ...
    $query = Doctrine::getTable('JobeetCategory')
      ->createQuery('a');

    if ($tableMethod)
    {
      $query = Doctrine::getTable('JobeetCategory')->$tableMethod($query);
    }
  ...
  {
    return Doctrine::getTable('JobeetCategory')->hasColumn($column);
  }
}
